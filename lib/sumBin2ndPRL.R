##=======================================================================
# sumBin2ndPRL - Sum of Binomial distributed Probit Regression          #
...
#                                                                       #
# Usage: res  <- sumBin2ndPRL(theta, D, post.resp)                      #
#                                                                       #
# Input:                                                                #
...
#                                                                       #
##=======================================================================
sumBin2ndPRL <- function(theta, D, post.resp){
  res <- 0
  for (i in 1:length(D)){
    res = res + bin2ndProbRegLik(theta, D[[i]], mode=1) * post.resp[i]
  }
  return(res)
}